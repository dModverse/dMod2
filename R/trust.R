...
#'       updates from does. A stall is made of rejected steps, so one is taken
#'       only after the iterate moves; a run that stalls again without moving
#'       stops the way \code{"never"} does. \code{nReseed} counts them.}
